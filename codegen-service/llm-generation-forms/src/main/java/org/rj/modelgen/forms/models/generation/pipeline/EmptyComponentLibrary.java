...
/**
 * A no-op component library used for pipeline stages that perform simple text-to-text
 * transformations and do not require any component library context (e.g. sanitization,
 * intent formalisation).
 */
