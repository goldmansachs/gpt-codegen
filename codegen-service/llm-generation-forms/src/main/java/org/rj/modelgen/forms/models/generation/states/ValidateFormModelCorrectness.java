...
public class ValidateFormModelCorrectness extends ModelInterfaceState {
    ...
    public ValidateFormModelCorrectness() throws Exception {
        ...
        SchemaRegistry schemaRegistry = SchemaRegistry.withDefaultDialect(Dialects.getDraft202012(), builder -> {
            // 2. Register URI Mappings (Indirection)
    ...
    public static void main(String[] args) {
        try {
            ...
            ValidateFormModelCorrectness validator = new ValidateFormModelCorrectness();

            String a2uiOutput;
            if (readModelFromFile) {
                a2uiOutput = new String(
                        ValidateFormModelCorrectness.class.getClassLoader()
