package org.rj.modelgen.bpmn.intrep.model.rendering.throwEvents;
...
import static org.rj.modelgen.bpmn.generation.BpmnConstants.NodeTypes.MESSAGE_INTERMEDIATE_THROW_EVENT;
...
public class MessageIntermediateThrowEventNode extends ElementNode {

    public MessageIntermediateThrowEventNode() {
        super();
    }

    public MessageIntermediateThrowEventNode(String id, String name) {
        super(id, name, MESSAGE_INTERMEDIATE_THROW_EVENT);
    }
    ...
    public <B extends AbstractFlowNodeBuilder<B, E>, E extends FlowNode> BpmnModelInstance render(AbstractFlowNodeBuilder<B, E> builder, BpmnComponent elementDefinition, String namespace) {
        var eventBuilder = builder.intermediateThrowEvent(id).name(name);
