...
import static org.rj.modelgen.bpmn.generation.BpmnConstants.NodeTypes.MESSAGE_INTERMEDIATE_CATCH_EVENT;
...
public class MessageIntermediateCatchEventNode extends ElementNode {

    public MessageIntermediateCatchEventNode() {
        super();
    }

    public MessageIntermediateCatchEventNode(String id, String name) {
        super(id, name, MESSAGE_INTERMEDIATE_CATCH_EVENT);
    }
