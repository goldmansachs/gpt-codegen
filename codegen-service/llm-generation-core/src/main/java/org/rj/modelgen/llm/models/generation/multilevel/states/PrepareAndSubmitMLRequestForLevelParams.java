...
public class PrepareAndSubmitMLRequestForLevelParams<TIntermediateModel extends IntermediateModel, TModelAssets extends ModelAssets,
    ...
    private final MultiLevelModelPhaseConfig<TIntermediateModel, TModelAssets, TComponentLibrary, TPrepareImpl, TSubmitImpl, TValidateImpl> config;
    ...
    public PrepareAndSubmitMLRequestForLevelParams(MultiLevelModelPhaseConfig<TIntermediateModel, TModelAssets, TComponentLibrary, TPrepareImpl, TSubmitImpl, TValidateImpl> config,
    ...
    public MultiLevelModelPhaseConfig<TIntermediateModel, TModelAssets, TComponentLibrary, TPrepareImpl, TSubmitImpl, TValidateImpl> getConfig() {
        return config;
    }
